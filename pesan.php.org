...
<head>
	...
	<?php
		...
		$result = mysql_query("SELECT film.nama_film, jadwal.harga,jadwal.jam_mulai,theater.kapasitas FROM film,jadwal,theater WHERE film.kode_film= $kode_film AND jadwal.kode_jadwal=$kode_jadwal AND theater.no_theater=$no_theater");
		...
		$resultKursi = mysql_query("SELECT COUNT(*) FROM transaksi WHERE kode_jadwal= $kode_jadwal AND no_theater=$no_theater AND waktu_transaksi LIKE '$tanggal%'");
		while ($dataKursiTotal = mysql_fetch_array($resultKursi)){
		    	...
		    	<div class="white-box">
		    		...
		    		<form action="input_pesan.php" method="POST" name="pesanKursi">	
			    		<table cellspacing =0 align="center" class="table-kursi">
			    			...
			    			<tr>
								<?php
									$result1 = mysql_query("SELECT * FROM kursi WHERE no_theater=$no_theater AND no_kursi LIKE '%A'");
									while ($A1 = mysql_fetch_array($result1)){
										$query1 = mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater AND no_kursi LIKE'%A' AND waktu_transaksi LIKE '$tanggal%'");
										while($datakursi= mysql_fetch_array($query1)){
							...
							<tr>
								<?php
									$result2 = mysql_query("SELECT * FROM kursi WHERE no_theater=$no_theater AND no_kursi LIKE '%B'");
									while ($B1 = mysql_fetch_array($result2)){	
										$query2 = mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater AND no_kursi LIKE'%B' and waktu_transaksi LIKE '$tanggal%'");
										while($datakursi2= mysql_fetch_array($query2)){
							...
							<tr>
								<?php
									$result3 = mysql_query("SELECT * FROM kursi WHERE no_theater=$no_theater AND no_kursi LIKE '%C'");
									while ($C1 = mysql_fetch_array($result3)){
										$query3 = mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater AND no_kursi LIKE'%C' and waktu_transaksi LIKE '$tanggal%'");
										while ($datakursi3= mysql_fetch_array($query3)){
							...
							<tr>
								<?php 
									$result4 = mysql_query("SELECT * FROM kursi WHERE no_theater=$no_theater AND no_kursi LIKE '%D'");
									while ($D1 = mysql_fetch_array($result4)){
										$query4 = mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater AND no_kursi LIKE'%D' and waktu_transaksi LIKE '$tanggal%'");
										while($datakursi4 = mysql_fetch_array($query4)){
							...
							<tr>
								<?php
									$result5 = mysql_query("SELECT * FROM kursi WHERE no_theater=$no_theater AND no_kursi LIKE '%E'");
									while ($E1=mysql_fetch_array($result5)){
										$query5= mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater AND no_kursi LIKE '%E' and waktu_transaksi LIKE '$tanggal%'");
										while($datakursi5 = mysql_fetch_array($query5)){
							...
							$query = mysql_query("SELECT * FROM transaksi WHERE kode_jadwal=$kode_jadwal AND no_theater=$no_theater");
							while($datakursi= mysql_fetch_array($query)){
							?>
