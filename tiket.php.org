...
//	$jam	 	= $tanggalwaktu->format('H:i');
	...
	$result= mysql_query("SELECT id_transaksi FROM transaksi where nama_film='$nama_film' AND jam_mulai='$jam_mulai' AND no_kursi='$no_kursi[$i]' AND no_theater='$no_theater' AND waktu_transaksi LIKE '$waktu%'");
