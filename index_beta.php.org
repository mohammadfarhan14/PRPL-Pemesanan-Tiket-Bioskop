	...
	<div class="row">		
		<div class="col-12">
		    <div class="white-box">
				...
				<?php
					$result1 = mysql_query("SELECT * FROM film WHERE akhir_tayang >NOW()");
					...
					?>
						<td colspan="2">
							...
							<?php 
								$result2 = mysql_query("SELECT theater.nama_theater,jadwal.jam_mulai,penayangan.id_theater,penayangan.id_jadwal from penayangan left join jadwal on jadwal.kode_jadwal=penayangan.id_jadwal left join theater on theater.no_theater=penayangan.id_theater order by theater.nama_theater");
